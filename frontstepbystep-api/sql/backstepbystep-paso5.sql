...
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, descuento, precio) values (100, 'The Lord of the Rings', '930330149-8', 'https://images-na.ssl-images-amazon.com/images/I/516GyHY9p6L.jpg', 'Supplement R Tympanic Membrane with Synth Sub, Via Opening', '8/20/1996',100, 0, 40000);
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, descuento, precio) values (200, 'Harry Potter and the Sorcerer´s Stone', '507119915-7', 'http://m.cdn.blog.hu/ko/kockagyar/image/harry_potter_poster/harry_potter_1.jpg', 'Occlusion of Right Femoral Artery, Percutaneous Approach', '2/19/2014',100, 20, 50000);
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, descuento, precio) values (300, 'A Game of Thrones', '279453624-9', 'https://cdn.waterstones.com/bookjackets/large/9780/0075/9780007548231.jpg', 'Removal of Spacer from T-lum Jt, Perc Approach', '4/7/1998',100, 30, 60000);
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, descuento, precio) values (400, 'The Winds of Winter', '744706866-7', 'http://www.darkmediaonline.com/wp-content/uploads/2013/01/WindsofWinter.jpg', 'Reposition Left Femoral Shaft, Perc Endo Approach', '10/10/1998',200, 0, 12500);
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, descuento, precio) values (500, 'The Slow Regard of Silent Things', '260760424-9', 'http://www.patrickrothfuss.com/images/page/cover-slow-regard_277.jpg', 'Supplement Lower Artery with Autol Sub, Perc Approach', '5/9/2013',200, 0, 13000);
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, descuento, precio) values (600, 'Harry Potter and the Philosopher´s Stone', '260760424-9', 'https://katemacdonalddotnet.files.wordpress.com/2015/11/potter-1-4.jpg', 'disse accumsan tortor quis turp Perc Approach', '5/9/2013',200, 10, 70000);
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, descuento, precio) values (700, 'Little Red Riding Hood', '2896875948', 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Little_Red_Riding_Hood_-_J._W._Smith.jpg/800px-Little_Red_Riding_Hood_-_J._W._Smith.jpg', 'This is a European fairy tale about a young girl and a Big Bad Wolf', '11/12/2019',100, 0, 25000);
